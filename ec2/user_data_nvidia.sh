...
#this script depends on an ami which is setup with nvidia drivers and docker
# can uncomment lines 17 and 18 to install nvidia drivers and docker on clean image
